...
class WhatsApp {
  ...
  Future messagesTemplate(
      {int? to, String? templateName = 'hello_world'}) async {
  ...
  Future registerNumber({pin}) async {
    var url = 'https://graph.facebook.com/v19.0/$_fromNumberId/register';
  ...
  Future deregisterNumber({pin}) async {
    var url = 'https://graph.facebook.com/v19.0/$_fromNumberId/deregister';
  ...
  Future getWhatsAppBusinessAccounts({inputToken}) async {
    var url =
        'https://graph.facebook.com/v19.0/debug_token?input_token=$inputToken';
  ...
  Future getWhatsAppBusinessAccountsList({accountId}) async {
    ...
    var url =
        'https://graph.facebook.com/v19.0/$parseAccountId/client_whatsapp_business_accounts';
  ...
  ///[mediaFilepath] is the file object to be send
  ...
  Future uploadMedia({
    ...
    var uri =
        Uri.parse('https://graph.facebook.com/v19.0/$_fromNumberId/media');

    print('head $_headers');
    var request = http.MultipartRequest('POST', uri);
    request.headers.addAll(_headers!);
    request.fields['messaging_product'] = 'whatsapp';
    request.fields['file'] = mediaFilepath;
    request.files.add(http.MultipartFile.fromBytes(
        'file', File(mediaFilepath).readAsBytesSync(),
  ...
  Future updateProfile(
    ...
    var url =
        'https://graph.facebook.com/v19.0/$_fromNumberId/whatsapp_business_profile';
