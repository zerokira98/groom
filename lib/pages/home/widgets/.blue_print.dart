...
class _PrintWidgetState extends State<PrintWidget> {
  PrintBluetoothThermal bluetooth = PrintBluetoothThermal();
      ...
      blue.isConnected
          .then((value) {
            ...
            for (var i = 0; i < theData.itemCards.length; i++) {
              sumtotal += theData.itemCards[i].pcs * theData.itemCards[i].price;
              var col1 = theData.itemCards[i].pcs.toString();
              var col2 = (theData.itemCards[i].price * theData.itemCards[i].pcs)
            ...
            blue.printLeftRight(
              "TOTAL :",
              sumtotal.numberFormat(currency: true),
            ...
            blue.printNewLine();
            blue.printQRcode(
              "instagram.com/groom_barbershop_pare",
              200,
              200,
              x.Align.center.val,
            );
        ...
        ElevatedButton(
          ...
          child: const Row(
            ...
            children: [
              ...
              Text('Print Bluetooth', style: TextStyle(color: Colors.white)),
            ],
          ),
        ),
      ],
