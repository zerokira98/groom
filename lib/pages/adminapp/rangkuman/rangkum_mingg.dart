                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        var separatorStyle = const TextStyle(
                          color: Colors.white,
                        );
                        return Column(
                          children: [
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    ...
                                    Theme.of(
                                      context,
                                    ).primaryColorDark.withValues(alpha: 0.45),
                                  ],
                                ),
                              ),
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    totalHarian.numberFormat(currency: true),
                                    style: separatorStyle,
                                  ),
                                ],
                              ),
                            ...
                            for (var z in state.daily[index + 0])
                              ListTile(
                                ...
                                subtitle: Text(
                                  z.totalPendapatan.numberFormat(
                                    currency: true,
                                  ),
                                ),
                              ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            TipePengeluaran tipe = state.pengeluaranlist.keys
                                .toList()[index];
                            return ListTile(
                              title: Text(tipe.name),
                              subtitle: Text(
                                (state.pengeluaranlist.values
                                            .toList()[index]['sum']
                                        as num)
                              ...
                              onTap: () => showDialog(
                                ...
                                builder: (context) => Dialog(
                                  child: ListView.builder(
                                    itemCount:
                                        (state.pengeluaranlist[tipe]['list']
                                                as List)
                                            .length,
                                    itemBuilder: (context, index) =>
                                        TilePengeluaran(
        ...
        return ListTile(
          ...
          subtitle: Row(
            children: [
              ...
              Text(
                (totcut + hutang).toInt().toString().numberFormat(
                      currency: true,
                    ) ??
                    'err pars',
              ),
...
class _SlipGajiState extends State<SlipGaji> {
  Future<Widget> bon() async {
    ///total
    var a = await RepositoryProvider.of<BonRepository>(
      context,
          ...
          children: [
            ...
            Row(
              children: [
                const Text('Total : '),
                Text(
                  ((totHC) + (totSHV) + (totCLR) + (totBRG) + (totLain))
                      .numberFormat(),
                ),
              ],
            ),
